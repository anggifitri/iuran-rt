                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="relative flex items-center">
                                <span class="absolute left-3 flex items-center pointer-events-none" style="color: #6b7280;">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror"
                                       ...
                                       placeholder="*******" style="padding-left:2.75rem;">
                                <button class="absolute flex items-center" type="button" onclick="toggleRegisterPass('password','eyeReg1','eyeOffReg1')" style="background: transparent; border:none; color: var(--text-muted); right:-12px; top:50%; transform:translateY(-50%); cursor:pointer;" tabindex="-1">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" required placeholder="*******" style="padding-left:2.75rem;">
                                <button class="absolute flex items-center" type="button" onclick="toggleRegisterPass('password_confirmation','eyeReg2','eyeOffReg2')" style="background: transparent; border:none; color: var(--text-muted); right:-12px; top:50%; transform:translateY(-50%); cursor:pointer;" tabindex="-1">
