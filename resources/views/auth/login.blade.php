...
<head>
    ...
    <style>
        ...
        .form-card .absolute { z-index: 10; pointer-events: auto; }
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                ...
                                <button type="button" onclick="toggleLoginPassword()"
                                    class="absolute flex items-center justify-center focus:outline-none"
                                    style="color: #94a3b8; width: auto; height: auto; padding: 0; background: transparent; border: none; right: 14px; top: 50%; transform: translateY(-50%);" tabindex="-1">
                                    <svg id="loginEyeIcon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>
                                    </svg>
                                    <svg id="loginEyeOffIcon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: none;">
