...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-white fw-bold">Tambah Data Warga</h2>
        ...
        <div class="card-body p-4">
            <form action="{{ route('warga.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" required class="form-control bg-secondary text-white border-0" placeholder="Masukkan nama lengkap">
                </div>

                <div class="mb-3">
                    <label class="form-label text-white">Blok Rumah (Contoh: A1/12)</label>
                    <input type="text" name="blok_rumah" value="{{ old('blok_rumah') }}" required class="form-control bg-secondary text-white border-0" placeholder="Contoh: A1/12">
                </div>

                <div class="mb-3">
                    <label class="form-label text-white">No. KK</label>
                    <input type="text" name="no_kk" value="{{ old('no_kk') }}" class="form-control bg-secondary text-white border-0" placeholder="Masukkan No. KK">
                </div>

                <div class="mb-3">
                    <label class="form-label text-white">NIK</label>
                    <input type="text" name="nik" value="{{ old('nik') }}" class="form-control bg-secondary text-white border-0" placeholder="Masukkan NIK">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nomor_hp" value="{{ old('nomor_hp') }}" class="form-control bg-secondary text-white border-0" placeholder="Masukkan nomor HP (Boleh kosong)">
                </div>
